...
Model0.Parent = mas
ParticleEmitter1.Parent = Model0
...
ParticleEmitter1.Texture = "rbxassetid://616445016"
ParticleEmitter1.Size = NumberSequence.new(0,0.18025299906730652,0,0)
...
ParticleEmitter2.Texture = "rbxassetid://616445016"
ParticleEmitter2.Transparency = NumberSequence.new(0.4000000059604645,1,0)
ParticleEmitter2.Size = NumberSequence.new(0,0.18025299906730652,0,0)
		...
		for i, v in pairs(b.Parent:GetChildren()) do
			if v:IsA("BasePart") then
				...
				do
					...
					part.CanCollide = false
					v:Destroy()
					local a = Model0.ParticleEmitter:Clone()
					a.Parent = part
...
plr = p
DebrisModel = Instance.new("Model", Rig)
...
for i, v in pairs(char:GetChildren()) do
	if v:IsA("Part") and v.Name ~= "HumanoidRootPart" then
		local emitter = Model0.ParticleEmitter2:Clone()
		emitter.Parent = v
...
local thing = rs:connect(function()
	--hum.MaxHealth = 200
